...
- `run-test.mjs` — suíte de testes do projeto (Testes 1–17; o 14 cobre o painel v2, o 15/16 o painel v3/Field Builder e o 17 a auditoria de dados); executar com `node scripts/run-test.mjs`.
